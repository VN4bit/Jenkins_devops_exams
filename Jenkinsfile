            ...
            steps {
                script {
                    sh """
                        ...
                        sed -i 's|HEAD-[0-9]*-[a-f0-9]*|${BUILD_TAG}|g' charts/values-dev.yaml
            ...
            steps {
                script {
                    sh """
                        ...
                        sed -i 's|HEAD-[0-9]*-[a-f0-9]*|${BUILD_TAG}|g' charts/values-qa.yaml
            ...
            steps {
                script {
                    sh """
                        ...
                        sed -i 's|HEAD-[0-9]*-[a-f0-9]*|${BUILD_TAG}|g' charts/values-staging.yaml
